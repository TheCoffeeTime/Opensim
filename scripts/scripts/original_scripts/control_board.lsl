...
init(string scriptUrl)
{
 ...
 //   string url = "http://trove.cs.man.ac.uk/trove/inworld/radiobuttons.html?url=" + scriptUrl;
    ...
    llSetPrimMediaParams(face, [PRIM_MEDIA_CURRENT_URL, url, PRIM_MEDIA_AUTO_SCALE, TRUE, PRIM_MEDIA_AUTO_PLAY, TRUE, PRIM_MEDIA_PERMS_CONTROL, PRIM_MEDIA_PERM_NONE, PRIM_MEDIA_WIDTH_PIXELS, 512,PRIM_MEDIA_AUTO_ZOOM,TRUE, PRIM_MEDIA_HEIGHT_PIXELS, 512, PRIM_MEDIA_FIRST_CLICK_INTERACT, 1]);
     integer face2 = 2;
    llClearPrimMedia(face2);
    llSetPrimMediaParams(face2, [PRIM_MEDIA_CURRENT_URL, url, PRIM_MEDIA_AUTO_SCALE, TRUE, PRIM_MEDIA_AUTO_PLAY, TRUE, PRIM_MEDIA_PERMS_CONTROL, PRIM_MEDIA_PERM_NONE, PRIM_MEDIA_WIDTH_PIXELS, 512,PRIM_MEDIA_AUTO_ZOOM,TRUE, PRIM_MEDIA_HEIGHT_PIXELS, 512, PRIM_MEDIA_FIRST_CLICK_INTERACT, 1]);
    // http://
