...
namespace OpenSim.Region.OptionalModules.Example.BareBonesNonShared
{
    ...
    class RadioPower
    {
        ...
        /// </summary>
        /// <param name="value">Value in Watt to be converted to dBW</param>
        /// <returns>power in dBW</returns>
        public static double ConvertWTodBW(double value)
        {
        ...
        public static double ConvertdBWToW(double value)
        {
